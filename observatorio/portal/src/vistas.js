...
<div class="mintic-page-intro mb-4"><div><h1>Administración</h1><p>Estado de los conectores, recolección de datos, usuarios del portal y auditoría.</p></div>
...
<div class="row g-4">
  <div class="col-lg-5"><div class="card h-100"><div class="card-header">Usuarios del portal</div><div class="card-body p-0"><div class="table-responsive"><table class="table table-sm mb-0"><thead><tr><th>Correo</th><th>Rol</th><th>Último ingreso</th><th class="text-end">Vínculos</th></tr></thead><tbody>${usuarios.map((u) => `<tr><td>${esc(u.correo)}</td><td>${esc(u.rol)}</td><td class="small">${esc(u.ultimo_ingreso || '')}</td><td class="text-end">${u.vinculos}</td></tr>`).join('')}</tbody></table></div></div></div></div>
  <div class="col-lg-7"><div class="card h-100"><div class="card-header">Auditoría reciente</div><div class="card-body p-0"><div class="table-responsive"><table class="table table-sm mb-0"><thead><tr><th>Fecha</th><th>Evento</th><th>Aplicativo</th><th>Detalle</th></tr></thead><tbody>${auditoria.map((a) => `<tr><td class="small"><code>${esc(a.ocurrido_en)}</code></td><td>${esc(a.evento)}</td><td>${esc(a.app || '')}</td><td class="small text-muted">${esc(a.detalle || '')}</td></tr>`).join('')}</tbody></table></div></div></div></div>
</div>` });
}
