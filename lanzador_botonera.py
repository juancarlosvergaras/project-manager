"""Punto de entrada de Botonera.exe.

Sin argumentos hace la instalación guiada; con argumentos se comporta como la
orden `botonera`, para que la tarea programada lo lance con
`Botonera.exe servicio`. Al terminar el asistente espera a que pulses Intro:
...
def main() -> int:
    from botonera.cli import main as cli
