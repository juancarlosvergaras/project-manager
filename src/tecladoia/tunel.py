...
Antes, para que ``ahakey.proyectoia.org``, ``minimic.proyectoia.org`` o
``sikaimini.proyectoia.org`` llegaran a un PC había que hacer tres cosas en ese PC: ponerle clave al
...
registro = logging.getLogger("tecladoia.tunel")
